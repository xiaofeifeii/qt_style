...
void QUICreator::initTableWidget()
{
    ...
    ui->tableWidget->setColumnWidth(0, int(width * 0.06));
    ui->tableWidget->setColumnWidth(1, int(width * 0.10));
    ui->tableWidget->setColumnWidth(2, int(width * 0.06));
    ui->tableWidget->setColumnWidth(3, int(width * 0.10));
    ui->tableWidget->setColumnWidth(4, int(width * 0.15));
